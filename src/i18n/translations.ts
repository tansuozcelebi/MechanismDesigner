...
export const en = {
  ...
  'panels.openDesign': 'Design',
  'panels.openResults': 'Results',
  'panels.designTitle': 'Design panels',
  'panels.resultsTitle': 'Results panels',
  'panels.close': 'Close panel',
  'panels.collapseAll': 'Collapse all',
  'panels.expandAll': 'Expand all',
...
export const tr: Record<TranslationKey, string> = {
  ...
  'panels.openDesign': 'Tasarım',
  'panels.openResults': 'Sonuçlar',
  'panels.designTitle': 'Tasarım panelleri',
  'panels.resultsTitle': 'Sonuç panelleri',
  'panels.close': 'Paneli kapat',
  'panels.collapseAll': 'Tümünü kapat',
  'panels.expandAll': 'Tümünü aç',
