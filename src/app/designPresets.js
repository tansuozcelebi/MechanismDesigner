 ...
 */
export const INITIAL_GUESS = arrayToDesign([
    12.7663, // phi6
    87.5913, // lAB
    83.1209, // c3r
    -145.3453, // c3a
 ...
 */
export const OPTIMIZED = optimizedResult;
export const hasOptimizedResults = () => (OPTIMIZED?.solutions?.length ?? 0) > 0;
export const bestOptimizedDesign = () => hasOptimizedResults() ? arrayToDesign(OPTIMIZED.solutions[0].designArray) : null;
export const designAt = (index) => {
...
export function designEntries(d) {
